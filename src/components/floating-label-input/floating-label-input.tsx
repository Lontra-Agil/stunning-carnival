...
import type { UseFormClearErrors, UseFormRegisterReturn } from "react-hook-form";
...
function FloatingLabelInput({
  ...
  const debouncedUpdate = (
    ...
    debounce((value: string, currentErrorMessage: string | undefined) => {
      if (currentErrorMessage) {
        clearErrors && clearErrors(register?.name);
      }
  ...
  return (
    <div
      ...
      id="omni-input-container"
    >
      <div
        className={`floating-label-input-container floating-label-input-border ${errorMessage ? "error" : ""
