            ...
            <div className="p-8 sm:p-12">
              ...
              <div className="space-y-3">
                <Button
                  type="button"
                  variant="outline"
                  className="w-full h-12 border-border/50 hover:bg-background/50 text-foreground flex items-center justify-center gap-3 bg-transparent"
                >
              ...
              <p className="text-xs text-center text-foreground/50 px-4 mt-6">
