...
export function DashboardDeveloperLayout({ children }: DashboardLayoutProps) {
	...
	const navigation = [
		...
		{ name: "Projetos", href: "/dashboard/projetos", icon: FolderGit2 },
		{
	...
	const notifications = [
		{
			...
			message: "Você foi adicionado ao projeto 'E-commerce Platform'",
			time: "5 min atrás",
			unread: true,
		},
		{
			...
			message: "Sua performance aumentou 15% esta semana",
			time: "2 horas atrás",
			unread: true,
		},
		{
			...
			message: "Maria Silva enviou uma mensagem",
			time: "1 dia atrás",
			unread: false,
		},
		{
			...
			message: "Pagamento de R$ 5.000 foi confirmado",
			time: "2 dias atrás",
			unread: false,
		},
	];
										...
										<div className="border-border/50 border-b bg-gradient-to-br from-primary/10 via-accent/5 to-transparent p-6">
											<div className="flex items-center gap-4">
												...
												<div className="min-w-0 flex-1">
													...
													<div className="mt-2 inline-flex items-center gap-1 rounded-full bg-primary/10 px-2 py-1 font-medium text-primary text-xs">
